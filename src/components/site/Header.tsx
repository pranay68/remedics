		...
		>
			<div className="mx-auto flex max-w-6xl items-center justify-between gap-6 px-6">
				<Magnetic>
					...
					>
						<div className="relative h-10 w-10 overflow-hidden rounded-xl border border-white/10 bg-white/5 shadow-2xl transition-all duration-500 group-hover:border-white/20 group-hover:scale-105">
							<Image 
								src="/logo.png" 
								alt="Aternox Logo" 
								width={40}
				...
				<div className="flex items-center gap-4">
					<Magnetic>
						<Link
							href="/contact"
							className="hidden md:flex h-10 items-center justify-center rounded-full bg-white px-6 text-[13px] font-bold text-black transition-all hover:bg-white/90"
						>
							Get Started
						</Link>
					</Magnetic>
