      ...
      <div className="mx-auto flex max-w-4xl items-center justify-between gap-6 px-5 py-4">
        <Link href="/" className="group flex items-center gap-2.5 transition-opacity hover:opacity-80">
          ...
          <div className="leading-tight">
            <div className="text-display text-sm font-medium tracking-[-0.01em]">Remedics</div>
          </div>
        </Link>
        ...
        <div className="flex items-center gap-2">
          <Link
            href="#download"
            className="hidden rounded-full px-3 py-1.5 text-[13px] text-white/50 transition-all duration-200 hover:text-white/80 hover:bg-white/[0.04] md:inline-flex"
          >
            Download
          </Link>
          <Link
