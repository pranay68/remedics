      ...
      <main className="noise cursor-crosshair">
        ...
        <Section className="py-24">
          <div className="grid gap-4 md:grid-cols-3">
            ...
            <Card
              ...
              headline="Science. Law. Finance. Engineering."
        ...
        <Section className="pb-24">
          <div className="rounded-3xl border border-white/[0.08] bg-white/[0.02] p-10 md:p-16 backdrop-blur">
            <div className="font-mono text-[10px] font-semibold tracking-widest text-white/40 uppercase">
              PROOF OF CONCEPT / FLT3-MUTATED AML
            </div>
        ...
        <Section className="pb-24">
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            ...
            <Card
              label="SYNTHETIC"
              headline="Discovery-level synthesis. Genuinely new structured knowledge."
              body="This is the crown. Restricted access. Not publicly available and not for sale."
              badge="RESTRICTED — Not available"
            />
          </div>
        </Section>
